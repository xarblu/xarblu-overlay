...
GENTOO_PATCHSET=linux-gentoo-patches-6.15.9-r1
# https://github.com/projg2/gentoo-kernel-config
GENTOO_CONFIG_VER=g16
# https://github.com/CachyOS/linux-cachyos
CONFIG_COMMIT=51880dac026d6160c68e05a7795fef668e68ea2b
CONFIG_PV="${PV}-${CONFIG_COMMIT::8}"
CONFIG_P="${PN}-${CONFIG_PV}"
# https://github.com/CachyOS/kernel-patches
PATCH_COMMIT=124e50fd89d80e2fb25d2e9c517ff61ac7d4f9b2
...
CACHY_PATCH_SPECS=(
	...
	# flavours
	#cachyos:sched/0001-bore-cachy.patch # upstream: "waiting for rebase"
	...
	# clang
	#clang:misc/dkms-clang.patch # dropped?
)
...
src_prepare() {
	...
	# upstreamed
	rm "${WORKDIR}/patches/2009_btrfs-fix-log-tree-replay-failure-due-to-file-with-0.patch" || die

...
BCACHEFS_PATCH_DATE=20250908103009
...
src_prepare() {
	...
	rm "${WORKDIR}/patches/2010_selftests-net-add-test-for-destination-in-broadcast-.patch" || die
	rm "${WORKDIR}/patches/2011_platform-x86-asus-wmi-Fix-racy-registrations.patch" || die

...
inherit eapi9-pipestatus toolchain-funcs flag-o-matic llvm-r1 rust kernel-build verify-sig

# https://distfiles.gentoo.org/pub/proj/dist-kernel/patchsets/
GENTOO_PATCHSET=linux-gentoo-patches-7.1.2_p1
# https://github.com/gentoo/gentoo-kernel-config
GENTOO_CONFIG_VER=g19
# https://github.com/CachyOS/linux-cachyos
CONFIG_COMMIT=8087687279f4c8b1b807b3cec91ca8f6842cb5b9
# https://github.com/CachyOS/kernel-patches
PATCH_COMMIT=f98908d8b5cacc4c24a6039ffd9f41f6a0de4ba2
# bcachefs backports version
# https://github.com/koverstreet/bcachefs-tools
# https://github.com/xarblu/bcachefs-patches
BCACHEFS_VER=1.38.9_pre20260703123859
...
BAD_PATCHES=(
	...
	2010_ipv6-account-for-fraggap-on-the-paged-allocation-pat.patch
	2011_ipv4-account-for-fraggap-on-the-paged-allocation-pat.patch
)
...
kernel_base_env_setup() {
	...
	if (( KERNEL_RC > 0 )); then
		archive="cachyos-${KERNEL_BASE}-rc${KERNEL_RC}-${CACHY_REL}.tar.gz"
		SRC_URI+="
			${base_uri}/cachyos-${KERNEL_BASE}-rc${KERNEL_RC}-${CACHY_REL}/${archive}
			verify-sig? ( ${base_uri}/cachyos-${KERNEL_BASE}-rc${KERNEL_RC}-${CACHY_REL}/${archive}.asc )
		"
		S="${WORKDIR}/cachyos-${KERNEL_BASE}-rc${KERNEL_RC}-${CACHY_REL}"
	else
		archive="cachyos-${KERNEL_BASE}.${KERNEL_PATCH}-${CACHY_REL}.tar.gz"
		SRC_URI+="
			${base_uri}/cachyos-${KERNEL_BASE}.${KERNEL_PATCH}-${CACHY_REL}/${archive}
			verify-sig? ( ${base_uri}/cachyos-${KERNEL_BASE}.${KERNEL_PATCH}-${CACHY_REL}/${archive}.asc )
		"

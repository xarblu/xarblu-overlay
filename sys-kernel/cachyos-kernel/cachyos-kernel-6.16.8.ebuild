...
CONFIG_COMMIT=498cedd3d9604dff94672ce48c59dfe802116886
CONFIG_PV="${PV}-${CONFIG_COMMIT::8}"
CONFIG_P="${PN}-${CONFIG_PV}"
# https://github.com/CachyOS/kernel-patches
PATCH_COMMIT=5940956bc0637fe6b36d9d86c556d55d6836b5d3
...
BAD_PATCHES=(
	2009_proc-fix-type-confusion-in-pde_set_flags.patch
)

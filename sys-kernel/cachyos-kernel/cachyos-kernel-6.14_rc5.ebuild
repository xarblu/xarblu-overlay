...
CONFIG_COMMIT="c00e68df8b2d8cb99b4b996fcc29005b5e415707"
CONFIG_PV="${PV}-${CONFIG_COMMIT::8}"
CONFIG_P="${PN}-${CONFIG_PV}"
# https://github.com/CachyOS/kernel-patches
PATCH_COMMIT="c6802577b20bcbe781d8554b005b438f2ec9c8f0"
...
# adds cachos config sources to SRC_URI
...
# get the patches based on flavour choice in order of CACHY_PATCH_SPECS
cachy_get_patches() {

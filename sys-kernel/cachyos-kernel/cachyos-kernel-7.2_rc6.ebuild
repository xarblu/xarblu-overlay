...
cachy_flavour_defaults_kconfig() {
	...
	# currently broken
	if [[ "${PV}" == '7.2_rc6' ]]; then
		kconf unset T2BCE_AUDIO
	else
		die "Remove this if fixed"
	fi
}

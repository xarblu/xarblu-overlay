...
if [[ "${PV}" == *_pre* ]]; then
	# unstable versions come from the maintainers' forks
	COMMIT="fd4ee913fd950d1ba2a1ffa1e0de1ef90ed6c257"
	SRC_URI="
		https://github.com/nyanmisaka/jellyfin-ffmpeg/archive/${COMMIT}.tar.gz
			-> ${P}.tar.gz
	"
	S="${WORKDIR}/${PN}-${COMMIT}"
else

...
# Jonas Rakebrandt <xarblu@protonmail.com>
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Port of mercurial.eclass which only pulls the requested revision into the sourcedir
# @DESCRIPTION:
# This eclass is a port of mercurial.eclass which aims to be more efficient by
# only copying the requested EHG_REVISION into the source directory. It will still
# download the entire repo into the distfiles as 1) mercurial doesn't really support
# partial clones and 2) this allows easier jumping between revisions

...
SRC_URI="
	https://github.com/eza-community/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_prepare() {
	...
	if use man; then
		...
		pandoc --standalone -f markdown -t man man/eza_colors.5.md \
			-o contrib/man/eza_colors.5 || die "failed to create colors man pages"
		pandoc --standalone -f markdown -t man man/eza_colors-explanation.5.md \
			-o contrib/man/eza_colors.5 || die "failed to create colors explanation man pages"
		pandoc --standalone -f markdown -t man man/eza.1.md -o \
			contrib/man/eza.1 || die "failed to create man pages"
	fi

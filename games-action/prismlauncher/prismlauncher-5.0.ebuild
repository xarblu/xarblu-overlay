...
if [[ ${PV} == 9999 ]]; then
	...
	# The PrismLauncher's files are unpacked to ${WORKDIR}/PrismLauncher-${PV}
	S="${WORKDIR}/${MY_PN}-${PV}"

	KEYWORDS="~amd64"
fi

# Apache-2.0 for MultiMC (PrismLauncher is forked from it)
# GPL-3 for PrismLauncher
# LGPL-3+ for libnbtplusplus
# See the rest of PrismLauncher's libraries at https://github.com/PrismLauncher/PrismLauncher/tree/develop/libraries
LICENSE="Apache-2.0 BSD BSD-2 BSD-3 GPL-2+ GPL-3 ISC LGPL-2.1+ LGPL-3+ MIT"
...
pkg_postinst() {
	...
	# https://github.com/PrismLauncher/PrismLauncher/issues/227

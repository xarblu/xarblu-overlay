...
inherit chromium-2 desktop wrapper unpacker xdg

MY_PN="StudIP"
COMMIT="be0f9e24008f128dece60c7d7c7a5c9ebb3b97e3"
ELECTRON_V="39.2.7"
...
SRC_URI="
	https://github.com/CommandMC/${MY_PN}/archive/${COMMIT}.tar.gz -> ${P}-${COMMIT::8}.tar.gz
...
src_unpack() {
	...
	unpack "${P}-${COMMIT::8}.tar.gz" "${P}-node_modules.tar.xz"
}

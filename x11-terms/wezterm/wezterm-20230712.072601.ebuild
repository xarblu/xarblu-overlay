...
declare -A GIT_CRATES=(
	[image]='https://github.com/image-rs/image;fe069785ae245a2c510fd724ef96da283b05a236;image-%commit%'
	[xcb-imdkit]='https://github.com/wez/xcb-imdkit-rs;e59e4a6df065b702e0c22fa2dcea00bd8301a446;xcb-imdkit-rs-%commit%'
	[xcb]='https://github.com/rust-x-bindings/rust-xcb;dbdaa01c178c6fbe68bd51b7ad44c08172181083;rust-xcb-%commit%'
)
...
SUBMODULES=(
	"freetype2 github main@freetype https://github.com/wez/freetype2 de8b92dd7ec634e9e2b25ef534c54a3537555c11"
	...
	"harfbuzz github main@harfbuzz https://github.com/harfbuzz/harfbuzz 1d665c2b521512cdd56964138fc601debd1f1177"
...
src_prepare() {
	...
	pushd "${CARGO_HOME}"
	eapply "${FILESDIR}/wezterm-20230712-072601-xcb-crate.patch"
	popd || die

...
googledrive gstreamer +gtk kde ldap +mariadb odk pdfimport postgres qrcode test vulkan
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-7.1.5.2-bison-3.8.patch" # bug 8129
